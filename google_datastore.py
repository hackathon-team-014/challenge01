...
class GoogleDataStore:
    ...
    def insert(self, capitalId, received_json):
       ...
       # entity['location'] = search.GeoPoint(received_json['location']['latitude'], received_json['location']['longitude']) 
        entity['location-latitude'] = received_json['location']['latitude']
        entity['location-longitude'] = received_json['location']['longitude']
